            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left"   data-parsley-validate=""  method="post" enctype="multipart/form-data" action="<?php echo current_url() ?>">
					...
					<div class="form-group">
						<div class="col-sm-2"><label class="control-label">Title *</label></div>						<div class="col-sm-10"><input maxlength="200" type="text" name="name" value="<?php if(set_value('name')) { echo set_value('name');} else { echo $edit_data->name; } ?>" required="required" class="form-control" placeholder="Title">						<?php echo form_error('name') ? '<span class="error">'.form_error('name').'</span>' : ''?></div>					</div>
					<div class="form-group">
							<div class="col-sm-2">
 							<label class="control-label">Description *</label>
							</div>
							<div class="col-sm-10">
							<textarea class="disp" name="description"  placeholder="Description" required="required"><?php if(set_value('description')) { echo set_value('description');} else { echo $edit_data->description;  } ?></textarea>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <a href="<?=base_url()?>admin/model"> <button class="btn btn-primary" type="button">Cancel</button></a>
