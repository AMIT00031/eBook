...
<div class="container">
	<div class="row">
	    ...
	    <?php 	$i = 0; ?>
	    <?php 	foreach($list as $jobs){ ?>
	    			<?php 	if($i%3 == 0){ echo '<br/><div class="clearfix"></div>';}$i++;?>
				    	<div class="col-sm-3">
							<div class="job_post">
								<div class="detail">
									<?php 	$img = 'default.png';if(!empty($jobs->image)){$img = $jobs->image;}?>
									<div style="height:200px"><a href="<?php echo base_url().'global-wherehouse-detail/'.$jobs->id ?>"><img src="<?php echo base_url('uploads/inventory/'.$img);?>" style="height:100%;width:100%;" class="img-responsive"></a></div>
									<p><span><a href="<?php echo base_url().'global-wherehouse-detail/'.$jobs->id ?>"><?php echo $jobs->title;?></a></span></p>
									...
									<p>Location : <span> <?php echo $jobs->username;?></span></p>
								</div>
