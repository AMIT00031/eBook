...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('assets/front/css/color/color-1.css') ?>">
        <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900" rel="stylesheet">
        
        <link rel="stylesheet" href="<?php echo base_url('assets/front/css/parsley.css') ?>">
    ...
    <body>
        ...
        <?php $this->load->view('header/inquiry_header'); ?>
